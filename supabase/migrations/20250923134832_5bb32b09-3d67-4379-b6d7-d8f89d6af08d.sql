-- Simple approach: just create the cron job for daily notifications
-- First, try to unschedule any existing job
SELECT cron.unschedule('daily-bills-notifications');

-- Create the cron job to run daily notifications every day at 8 AM (Brazil timezone)
